...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", "https://nominatim.openstreetmap.org", "https://*.tile.openstreetmap.org", "https://unpkg.com", "https://*.supabase.co", "https://server.arcgisonline.com", "https://geocode.arcgis.com", "https://*.arcgis.com", "https://*.basemaps.cartocdn.com", "https://basemaps.cartocdn.com"]
        }
    }
}));
